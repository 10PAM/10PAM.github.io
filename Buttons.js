...
function picOfDay(action, description, date, url) {
    if (action == "Open") {
        ...
        "<button style='color: #ffffff; outline: none; background-color: rgba(119, 20, 20, 0); border-color: #ffffff; border-radius: 1%; text-align: center;font-size: 1.3vw; width: 60%; height: 5%;' id='Close' onclick=\"picOfDay('Close')\">Close</button>";
