...
! function webpackUniversalModuleDefinition(t, e) {
    ...
    var __webpack_modules__ = [, (t, e, s) => {
            ...
            e.arraysToBytes = function arraysToBytes(t) {
                ...
                for (let s = 0; s < e; s++) {
                    let e = t[s];
                    e instanceof Uint8Array || (e = "string" == typeof e ? stringToBytes(e) : new Uint8Array(e));
            ...
            class Util {
                ...
                static getAxialAlignedBoundingBox(t, e) {
                    ...
                    return [Math.min(s[0], n[0], i[0], r[0]), Math.min(s[1], n[1], i[1], r[1]), Math.max(s[0], n[0], i[0], r[0]), Math.max(s[1], n[1], i[1], r[1])]
                }
            ...
            function getDocument(t) {
                ...
                if ("string" == typeof t || t instanceof URL) s = {
                    ...
                    if ("object" != typeof t) throw new Error("Invalid parameter in getDocument, need either string, URL, TypedArray, or parameter object.");
                ...
                for (const t in s) {
                    ...
                    switch (t) {
                        ...
                        case "worker":
                            ...
                            continue;
                        case "data":
                            if (_is_node.isNodeJS && "undefined" != typeof Buffer && e instanceof Buffer) n[t] = new Uint8Array(e);
                            else {
                                ...
                                if ("string" == typeof e) n[t] = (0, _util.stringToBytes)(e);
                                    ...
                                    if (!(0, _util.isArrayBuffer)(e)) throw new Error("Invalid PDF binary data: either TypedArray, string, or array-like object is expected in the data property.");
            ...
            class PDFPageProxy {
                ...
                render({
                    ...
                    const g = a || new DefaultCanvasFactory({
                    ...
                    const b = m.task;
                    Promise.all([p.displayReadyCapability.promise, l]).then((([t, e]) => {
                ...
                getOperatorList({
                    ...
                    let i, r = this._intentStates.get(n.cacheKey);
                    if (!r) {
            ...
            class PDFWorker {
                ...
                constructor({
                    ...
                    if (e && PDFWorker.#e.has(e)) throw new Error("Cannot use more than one PDFWorker per port.");
                    this.name = t;
                    this.destroyed = !1;
                    this.verbosity = s;
                    this._readyCapability = (0, _util.createPromiseCapability)();
            ...
            class WorkerTransport {
                ...
                getRenderingIntent(t, e = _util.AnnotationMode.ENABLE, s = null, n = !1) {
                    ...
                    switch (e) {
                        ...
                        case _util.AnnotationMode.ENABLE_STORAGE:
                            ...
                            r = (i & _util.RenderingIntentFlag.PRINT && s instanceof _annotation_storage.PrintAnnotationStorage ? s : this.annotationStorage).serializable;
                            break;
                        default:
                ...
                setupMessageHandler() {
                    ...
                    t.on("PasswordRequest", (t => {
                        ...
                        if (e.onPassword) {
                            const updatePassword = t => {
                                t instanceof Error ? this._passwordCapability.reject(t) : this._passwordCapability.resolve({
                                    password: t
                                })
                            };
                            try {
                    ...
                    t.on("commonobj", (([e, s, n]) => {
                        if (!this.destroyed && !this.commonObjs.has(e)) switch (s) {
                            case "Font":
                                ...
                                let r = null;
                                i.pdfBug && globalThis.FontInspector?.enabled && (r = {
                                    registerFont(t, e) {
                                ...
                                this.fontLoader.bind(a).catch((s => t.sendWithPromise("FontFallback", {
                                    id: e
                                }))).finally((() => {
                    ...
                    t.on("DocStats", (t => {
                        this.destroyed || (this.#s = Object.freeze({
                ...
                getMetadata() {
                    return this.#r ||= this.messageHandler.sendWithPromise("GetMetadata", null).then((t => ({
                        info: t[0],
            ...
            class InternalRenderTask {
                ...
                initializeGraphics({
                    ...
                    if (this._canvas) {
                        if (InternalRenderTask.#c.has(this._canvas)) throw new Error("Cannot use the same canvas during multiple render() operations. Use different canvas or ensure previous operations were cancelled or completed.");
                    ...
                    this.gfx = new _canvas.CanvasGraphics(s, this.commonObjs, this.objs, this.canvasFactory, r, e, this.annotationCanvasMap, this.pageColors);
            ...
            class AnnotationEditor {
                ...
                getRect(t, e) {
                    const [s, n] = this.parent.viewportBaseDimensions, [i, r] = this.parent.pageDimensions, a = i * t / s, o = r * e / n, l = this.x * i, c = this.y * r, h = this.width * i, d = this.height * r;
                ...
                static deserialize(t, e) {
                    ...
                    const [n, i] = e.pageDimensions, [r, a, o, l] = s.getRectInCurrentCoords(t.rect, i);
                    s.x = r / n;
                    s.y = a / i;
                    s.width = o / n;
                    s.height = l / i;
            ...
            class ClipboardManager {
                ...
                copy(t) {
                    if (t) {
                        Array.isArray(t) ? this.#E = t.map((t => t.serialize())) : this.#E = [t.serialize()];
            ...
            class AnnotationEditorUIManager {
                ...
                static _keyboardManager = new KeyboardManager([
                    ...
                    [
                        ["Backspace", "alt+Backspace", "ctrl+Backspace", "shift+Backspace", "mac+Backspace", "mac+alt+Backspace", "mac+ctrl+Backspace", "Delete", "ctrl+Delete", "shift+Delete"], AnnotationEditorUIManager.prototype.delete
                    ],
                    [
                ...
                onEditingAction(t) {
                    ["undo", "redo", "cut", "copy", "paste", "delete", "selectAll"].includes(t.name) && this[t.name]()
                }
                #G(t) {
                    Object.entries(t).some((([t, e]) => this.#U[t] !== e)) && this.#R.dispatch("annotationeditorstateschanged", {
                        source: this,
                ...
                updateToolbar(t) {
                    t !== this.#O && this.#R.dispatch("switchannotationeditormode", {
                        source: this,
                        mode: t
                    })
                }
            ...
            e.getXfaPageViewport = function getXfaPageViewport(t, {
                ...
                const {
                    width: n,
                    height: i
                } = t.attributes.style, r = [0, 0, parseInt(n), parseInt(i)];
                    ...
                    r.onreadystatechange = () => {
                        if (r.readyState === XMLHttpRequest.DONE) {
                            if (200 === r.status || 0 === r.status) {
                                let t;
                                e && r.response ? t = new Uint8Array(r.response) : !e && r.responseText && (t = (0, i.stringToBytes)(r.responseText));
                                if (t) {
                                    s(t);
                                    return
                                }
            ...
            class PageViewport {
                constructor({
                    ...
                    this.transform = [l * e, c * e, h * e, d * e, u - l * e * a - h * e * o, p - c * e * a - d * e * o];
                    this.width = g;
                    this.height = f
                }
                clone({
            ...
            class CanvasGraphics {
                ...
                beginDrawing({
                    ...
                    if (this.foregroundColor && this.backgroundColor) {
                        ...
                        if ("#000000" === t && "#ffffff" === e || t === e || !s) this.foregroundColor = this.backgroundColor = null;
                        else {
                            const [s, r, a] = (0, n.getRGB)(i), newComp = t => (t /= 255) <= .03928 ? t / 12.92 : ((t + .055) / 1.055) ** 2.4, o = Math.round(.2126 * newComp(s) + .7152 * newComp(r) + .0722 * newComp(a));
                            this.selectColor = (s, n, i) => {
                                const r = .2126 * newComp(s) + .7152 * newComp(n) + .0722 * newComp(i);
                ...
                _scaleImage(t, e) {
                    const s = t.width,
                        n = t.height;
                    let i, r, a = Math.max(Math.hypot(e[0], e[1]), 1),
                ...
                _createMaskCanvas(t) {
                    ...
                    v.imageSmoothingEnabled = getImageSmoothingEnabled((0, n.getCurrentTransform)(v), t.interpolate);
                ...
                stroke(t) {
                    ...
                    if (this.contentVisible)
                        if ("object" == typeof s && s?.getPattern) {
                            e.save();
                            e.strokeStyle = s.getPattern(e, this, (0, n.getCurrentTransformInverse)(e), r.PathType.STROKE);
                ...
                fill(t) {
                    ...
                    if (this.current.patternFill) {
                        e.save();
                        e.fillStyle = s.getPattern(e, this, (0, n.getCurrentTransformInverse)(e), r.PathType.FILL);
                        i = !0
                    }
                ...
                setFont(t, e) {
                    ...
                    0 !== n.fontMatrix[0] && 0 !== n.fontMatrix[3] || (0, i.warn)("Invalid font matrix for font " + t);
                    if (e < 0) {
                        e = -e;
                        n.fontDirection = -1
                ...
                paintChar(t, e, s, r) {
                    ...
                    if (l.disableFontFace || p) {
                        ...
                        d !== i.TextRenderingMode.FILL && d !== i.TextRenderingMode.FILL_STROKE || a.fillText(t, e, s);
                        d !== i.TextRenderingMode.STROKE && d !== i.TextRenderingMode.FILL_STROKE || a.strokeText(t, e, s)
                    }
                    if (u) {
                ...
                showText(t) {
                    ...
                    const o = this.ctx,
                        ...
                        m = s.defaultVMetrics,
                        b = a * e.fontMatrix[0],
                        A = e.textRenderingMode === i.TextRenderingMode.FILL && !s.disableFontFace && !e.patternFill;
                    o.save();
                    ...
                    if (e.patternFill) {
                        o.save();
                        const t = e.fillColor.getPattern(o, this, (0, n.getCurrentTransformInverse)(o), r.PathType.FILL);
                    ...
                    if (0 === v || 0 === y) {
                        ...
                        t !== i.TextRenderingMode.STROKE && t !== i.TextRenderingMode.FILL_STROKE || (y = this.getSinglePixelWidth())
                    } else y /= v;
                    if (1 !== l) {
                        o.scale(l, l);
                        y /= l
                ...
                getColorN_Pattern(t) {
                    ...
                    if ("TilingPattern" === t[0]) {
                        const s = t[1],
                            ...
                            a = {
                                createCanvasGraphics: t => new CanvasGraphics(t, this.commonObjs, this.objs, this.canvasFactory)
                            };
                ...
                shadingFill(t) {
                    ...
                    e.fillStyle = s.getPattern(e, this, (0, n.getCurrentTransformInverse)(e), r.PathType.SHADING);
                ...
                beginAnnotation(t, e, s, r, a) {
                    ...
                    if (Array.isArray(e) && 4 === e.length) {
                        ...
                        if (a && this.annotationCanvasMap) {
                            ...
                            e[2] = r;
                            e[3] = o;
                            const [a, l] = i.Util.singularValueDecompose2dScale((0, n.getCurrentTransform)(this.ctx)), {
                                viewportScale: c
                            } = this, h = Math.ceil(r * this.outputScaleX * c), d = Math.ceil(o * this.outputScaleY * c);
                    ...
                    if (n) {
                        void 0 === n.compiled && (n.compiled = function compileType3Glyph(t) {
                            ...
                            const n = new Uint8Array([0, 2, 4, 0, 1, 0, 5, 4, 8, 10, 0, 8, 0, 2, 1, 0]),
                                i = e + 1;
                            let r, a, o, l = new Uint8Array(i * (s + 1));
                            const h = e + 7 & -8;
                ...
                paintImageMaskXObjectGroup(t) {
                    ...
                    for (const a of t) {
                        const {
                            ...
                            height: l,
                            transform: c
                        } = a, h = this.cachedCanvases.getCanvas("maskCanvas", o, l), d = h.context;
                        d.save();
                        putBinaryImageMask(d, this.getObject(t, a));
                        d.globalCompositeOperation = "source-in";
                        d.fillStyle = i ? s.getPattern(d, this, (0, n.getCurrentTransformInverse)(e), r.PathType.FILL) : s;
                        d.fillRect(0, 0, o, l);
                        d.restore();
                        e.save();
                        e.transform(...c);
                ...
                paintInlineImageXObject(t) {
                    ...
                    r.imageSmoothingEnabled = getImageSmoothingEnabled((0, n.getCurrentTransform)(r), t.interpolate);
                    const [l, c] = drawImageAtIntegerCoords(r, o.img, 0, 0, o.paintWidth, o.paintHeight, 0, -s, e, s);
                    if (this.imageLayer) {
                ...
                paintInlineImageXObjectGroup(t, e) {
                    ...
                    for (const l of e) {
                        ...
                        if (this.imageLayer) {
                            const [e, s] = i.Util.applyTransform([l.x, l.y], (0, n.getCurrentTransform)(this.ctx));
                            this.imageLayer.appendImage({
                                imgData: t,
                                left: e,
                                top: s,
                ...
                getScaleForStroking() {
                    if (!this._cachedScaleForStroking) {
                        const {
                            lineWidth: t
                        } = this.current, e = (0, n.getCurrentTransform)(this.ctx);
                        let s, i;
                        if (0 === e[1] && 0 === e[2]) {
            ...
            class RadialAxialShadingPattern extends BaseShadingPattern {
                ...
                getPattern(t, e, s, r) {
                    ...
                    if (r === a.STROKE || r === a.FILL) {
                        const a = e.current.getClippedPathBoundingBox(r, (0, i.getCurrentTransform)(t)) || [0, 0, 0, 0],
                    ...
                    case "lattice":
                        ...
                        for (r = 0; r < l; r++) {
                            ...
                            for (let r = 0; r < c; r++, e++) {
                                ...
                                drawTriangle(t, s, n[e + o + 1], n[e + 1], n[e + o], i[e + o + 1], i[e + 1], i[e + o])
                            }
                        }
                        break;
                    case "triangles":
                        for (r = 0, a = n.length; r < a; r += 3) drawTriangle(t, s, n[r], n[r + 1], n[r + 2], i[r], i[r + 1], i[r + 2]);
                        break;
                    default:
            ...
            class MeshShadingPattern extends BaseShadingPattern {
                ...
                getPattern(t, e, s, r) {
                    applyBoundingBox(t, this._bbox);
                    let o;
                    if (r === a.SHADING) o = n.Util.singularValueDecompose2dScale((0, i.getCurrentTransform)(t));
                    else {
            ...
            e.MessageHandler = class MessageHandler {
                ...
                async _deleteStreamController(t, e) {
                    await Promise.allSettled([t.startCall && t.startCall.promise, t.pullCall && t.pullCall.promise, t.cancelCall && t.cancelCall.promise]);
            ...
            e.OptionalContentConfig = class OptionalContentConfig {
                ...
                constructor(t) {
                    ...
                    if (null !== t) {
                        ...
                        this.#it = t.order;
                        for (const e of t.groups) this.#st.set(e.id, new OptionalContentGroup(e.name, e.intent));
                        if ("OFF" === t.baseState)
                            for (const t of this.#st.values()) t._setVisible(i, !1);
                ...
                static textContent(t) {
                    ...
                    ! function walk(t) {
                        ...
                        if ("#text" === n) s = t.value;
                            ...
                            t?.attributes?.textContent ? s = t.attributes.textContent : t.value && (s = t.value)
                        }
                        null !== s && e.push({
                            str: s
                        });
            ...
            class AnnotationEditorLayer {
                ...
                setDimensions() {
                    const {
                        ...
                        height: e,
                        rotation: s
                    } = this.viewport, n = s % 180 != 0, i = Math.floor(t) + "px", r = Math.floor(e) + "px";
            ...
            class FreeTextEditor extends r.AnnotationEditor {
                ...
                static initialize(t) {
                    this._l10nPromise = new Map(["free_text_default_content", "editor_free_text_aria_label"].map((e => [e, t.get(e)])));
                ...
                static get defaultPropertiesToUpdate() {
                    return [
                        ...
                        [n.AnnotationEditorParamsType.FREETEXT_COLOR, FreeTextEditor._defaultColor || r.AnnotationEditor._defaultLineColor]
                    ]
                }
                get propertiesToUpdate() {
                    return [
                ...
                getInitialTranslation() {
                    return [-FreeTextEditor._internalPadding * this.parent.scaleFactor, -(FreeTextEditor._internalPadding + this.#Et) * this.parent.scaleFactor]
                }
                rebuild() {
                    super.rebuild();
                ...
                #Tt() {
                    const [t, e] = this.parent.viewportBaseDimensions, s = this.div.getBoundingClientRect();
                ...
                render() {
                    ...
                    this.enableEditing();
                    FreeTextEditor._l10nPromise.get("editor_free_text_aria_label").then((t => this.editorDiv?.setAttribute("aria-label", t)));
                    FreeTextEditor._l10nPromise.get("free_text_default_content").then((t => this.editorDiv?.setAttribute("default-content", t)));
                    this.editorDiv.contentEditable = !0;
                    const {
                        style: s
                    } = this.editorDiv;
            ...
            class InkEditor extends i.AnnotationEditor {
                ...
                static initialize(t) {
                    this._l10nPromise = new Map(["editor_ink_canvas_aria_label", "editor_ink_aria_label"].map((e => [e, t.get(e)])))
                }
                static updateDefaultParams(t, e) {
                    switch (t) {
                ...
                static get defaultPropertiesToUpdate() {
                    return [
                        ...
                        [n.AnnotationEditorParamsType.INK_COLOR, InkEditor._defaultColor || i.AnnotationEditor._defaultLineColor],
                ...
                get propertiesToUpdate() {
                    return [
                        ...
                        [n.AnnotationEditorParamsType.INK_COLOR, this.color || InkEditor._defaultColor || i.AnnotationEditor._defaultLineColor],
                ...
                #Xt() {
                    ...
                    InkEditor._l10nPromise.get("editor_ink_canvas_aria_label").then((t => this.canvas?.setAttribute("aria-label", t)));
                ...
                render() {
                    ...
                    super.render();
                    InkEditor._l10nPromise.get("editor_ink_aria_label").then((t => this.div?.setAttribute("aria-label", t)));
                ...
                setDimensions(t, e) {
                    ...
                    if (this.#kt && Math.abs(this.#kt - t / e) > .01) {
                ...
                #oe(t, e, s, n) {
                    ...
                    for (const l of this.paths) {
                        ...
                        for (let i = 0, c = l.length; i < c; i++) {
                            const [c, h, d, u] = l[i], p = t * (c[0] + e) + r, g = n - t * (c[1] + s) - r, f = t * (h[0] + e) + r, m = n - t * (h[1] + s) - r, b = t * (d[0] + e) + r, A = n - t * (d[1] + s) - r, _ = t * (u[0] + e) + r, y = n - t * (u[1] + s) - r;
                            if (0 === i) {
                                a.push(p, g);
                                o.push(p, g)
                            }
                ...
                static deserialize(t, e) {
                    ...
                    s.opacity = t.opacity;
                    const [i, r] = e.pageDimensions, a = s.width * i, l = s.height * r, c = e.scaleFactor, h = t.thickness / 2;
                    s.#kt = a / l;
                    s.#Lt = !0;
                    s.#Ut = Math.round(a);
                    s.#qt = Math.round(l);
                ...
                serialize() {
                    ...
                    return {
                        ...
                        paths: this.#oe(this.scaleFactor / this.parent.scaleFactor, this.translationX, this.translationY, e),
                        pageIndex: this.parent.pageIndex,
                        rect: t,
                        rotation: this.rotation
                    }
            ...
            function fitCubic(t, e, s, n, i) {
                ...
                if (2 === t.length) {
                    ...
                    return [r = [t[0], maths.addArrays(t[0], maths.mulItems(e, m)), maths.addArrays(t[1], maths.mulItems(s, m)), t[1]]]
                }
                ...
                return f = (f = f.concat(fitCubic(t.slice(0, h + 1), e, p, n, i))).concat(fitCubic(t.slice(h), g, s, n, i))
            }

            function generateAndReport(t, e, s, n, i, r) {
                var a, o, l;
                a = function generateBezier(t, e, s, n) {
                    var i, r, a, o, l, c, h, d, u, p, g, f, m, b, A, _, y, v = t[0],
                        S = t[t.length - 1];
                    i = [v, null, null, S];
            ...
            t.exports = function fitCurve(t, e, s) {
                ...
                t.forEach((e => {
                    if (!Array.isArray(e) || e.some((t => "number" != typeof t)) || e.length !== t[0].length) throw Error("Each point should be an array of numbers. Each point should have the same amount of numbers.")
                }));
                if ((t = t.filter(((e, s) => 0 === s || !e.every(((e, n) => e === t[s - 1][n]))))).length < 2) return [];
                const n = t.length,
            ...
            class AnnotationElement {
                ...
                _createContainer(t = !1) {
                    ...
                    const g = n.Util.normalizeRect([e.rect[0], s.view[3] - e.rect[1] + s.view[1], e.rect[2], s.view[3] - e.rect[3] + s.view[1]]);
                    if (!t && e.borderStyle.width > 0) {
                        ...
                        i ? r.style.borderColor = n.Util.makeHexColor(0 | i[0], 0 | i[1], 0 | i[2]) : r.style.borderWidth = 0
                    }
                ...
                setRotation(t, e = this.container) {
                    const [s, n, i, r] = this.viewport.viewBox, a = i - s, o = r - n, {
                        width: l,
                        height: c
            ...
            class LinkAnnotationElement extends AnnotationElement {
                ...
                render() {
                    ...
                    if (this.quadrilaterals) return this._renderQuadrilaterals("linkAnnotation").map(((t, e) => {
                ...
                _bindResetFormAction(t, e) {
                    ...
                    if (this._fieldObjects) t.onclick = () => {
                        ...
                        if (0 !== t.length || 0 !== i.length) {
                            ...
                            for (const t of Object.values(this._fieldObjects)) a.push(...t);
                        ...
                        for (const t of a) {
                            ...
                            s && (c.has(s) ? s.dispatchEvent(new Event("resetform")) : (0, n.warn)(`_bindResetFormAction - element not allowed: ${e}`))
                        }
            ...
            class TextAnnotationElement extends AnnotationElement {
                constructor(t) {
                    super(t, {
                        isRenderable: !!(t.data.hasPopup || t.data.titleObj?.str || t.data.contentsObj?.str || t.data.richText?.str)
                    })
                }
                render() {
            ...
            class WidgetAnnotationElement extends AnnotationElement {
                ...
                _setEventListeners(t, e, s) {
                    for (const [n, i] of e)("Action" === i || this.data.actions?.[i]) && this._setEventListener(t, n, i, s)
                }
                    ...
                    if (this.renderForms) {
                        ...
                        if (this.enableScripting && this.hasJSActions) {
                            ...
                            s.addEventListener("blur", (t => {
                                ...
                                a.userValue = s;
                                this._mouseState.isDown && a.valueOnFocus !== s && this.linkService.eventBus?.dispatch("dispatcheventinsandbox", {
                                    source: this,
                                    detail: {
                                        id: e,
                                        name: "Keystroke",
            ...
            class RadioButtonWidgetAnnotationElement extends WidgetAnnotationElement {
                ...
                render() {
                    ...
                    i.addEventListener("change", (e => {
                        ...
                        for (const e of this._getElementsByName(n, s)) t.setValue(e.id, {
                            value: !1
                        });
                        t.setValue(s, {
                            value: i
                ...
                render() {
                    ...
                    const getValue = (t, e) => {
                            const s = e ? "value" : "textContent",
                                n = t.target.options;
                            return t.target.multiple ? Array.prototype.filter.call(n, (t => t.selected)).map((t => t[s])) : -1 === n.selectedIndex ? null : n[n.selectedIndex][s]
                        },
                        getItems = t => {
                        ...
                        n.addEventListener("updatefromsandbox", (s => {
                            const i = {
                                ...
                                remove(s) {
                                    ...
                                    n.remove(r);
                                    if (i.length > 0) {
                                        -1 === Array.prototype.findIndex.call(i, (t => t.selected)) && (i[0].selected = !0)
                                    }
                                    t.setValue(e, {
                                        value: getValue(s, !0),
                                        items: getItems(s)
                                ...
                                insert(s) {
                                    const {
                                        ...
                                        displayValue: r,
                                        exportValue: a
                                    } = s.detail.insert, o = n.children[i], l = document.createElement("option");
                                    l.textContent = r;
                                    l.value = a;
                                ...
                                items(s) {
                                    ...
                                    for (const t of i) {
                                        const {
                                            displayValue: e,
                                            exportValue: s
                                        } = t, i = document.createElement("option");
                                        i.textContent = e;
                                        i.value = s;
                                        n.append(i)
                                    }
            ...
            class PopupAnnotationElement extends AnnotationElement {
                constructor(t) {
                    super(t, {
                        isRenderable: !!(t.data.titleObj?.str || t.data.contentsObj?.str || t.data.richText?.str)
                    })
                }
                render() {
                    ...
                    const s = new PopupElement({
                        ...
                        i = this.page,
                        r = n.Util.normalizeRect([this.data.parentRect[0], i.view[3] - this.data.parentRect[1] + i.view[1], this.data.parentRect[2], i.view[3] - this.data.parentRect[3] + i.view[1]]),
            ...
            class FileAttachmentAnnotationElement extends AnnotationElement {
                ...
                render() {
                    ...
                    !this.data.hasPopup && (this.data.titleObj?.str || this.data.contentsObj?.str || this.data.richText) && this._createPopup(t, this.data);
                    this.container.append(t);
                    return this.container
                }
                _download() {
            ...
            class AnnotationLayer {
                        ...
                        if (e.isRenderable) {
                            ...
                            if (Array.isArray(t))
                                for (const e of t) {
                                    ...
                                    t.style.zIndex = l++;
                                    e instanceof PopupAnnotationElement ? s.prepend(t) : AnnotationLayer.#de(t, c.id, s, o)
                                }
                        }
                    }
                ...
                static #ue(t, {
                    ...
                    const {
                        style: i
                    } = t, r = n % 180 != 0, a = Math.floor(e) + "px", o = Math.floor(s) + "px";
                    i.width = r ? o : a;
                    i.height = r ? a : o;
            ...
            e.XfaLayer = class XfaLayer {
                    ...
                    switch (s.name) {
                        ...
                        case "input":
                            if ("radio" === s.attributes.type || "checkbox" === s.attributes.type) {
                                r.value === s.attributes.xfaOn ? t.setAttribute("checked", !0) : r.value === s.attributes.xfaOff && t.removeAttribute("checked");
                                if ("print" === i) break;
                        ...
                        case "select":
                            if (null !== r.value)
                                for (const t of s.children) t.attributes.value === r.value && (t.attributes.selected = !0);
                            t.addEventListener("input", (t => {
                ...
                static render(t) {
                    ...
                    for (; o.length > 0;) {
                        ...
                        let d;
                        d = l?.attributes?.xmlns ? document.createElementNS(l.attributes.xmlns, h) : document.createElement(h);
                        a.append(d);
            ...
            function appendText(t, e, s, i) {
                ...
                b && (u.vertical ? c.canvasWidth = e.height * t._viewport.scale : c.canvasWidth = e.width * t._viewport.scale);
            ...
            function render(t) {
                ...
                if (n > 1e5) {
                    ...
                    if (!t._textContentStream)
                        for (let s = 0; s < n; s++) t._layoutText(e[s]);
                    t._renderingDone = !0;
                    s.resolve()
                }
            }
            ...
            function expandBoundsLTR(t, e) {
                ...
                for (const t of e) {
                    ...
                    for (a = e; a <= r; a++) {
                        ...
                        i = n.boundary;
                        let e;
                        e = i.x2 > t.x1 ? i.index > t.index ? i.x1New : t.x1 : void 0 === i.x2New ? (i.x2 + t.x1) / 2 : i.x2New;
                        e > l && (l = e)
                    }
                    t.x1New = l;
                    for (a = e; a <= r; a++) {
                        n = s[a];
                        i = n.boundary;
                        void 0 === i.x2New ? i.x2 > t.x1 ? i.index > t.index && (i.x2New = i.x2) : i.x2New = l : i.x2New > l && (i.x2New = Math.max(l, i.x2))
                    }
                    const c = [];
                    let h = null;
                    for (a = e; a <= r; a++) {
            ...
            class TextLayerRenderTask {
                constructor({
                    ...
                    l && (0, i.deprecated)("The `enhanceTextSelection` functionality will be removed in the future.");
                    this._textContent = t;
                ...
                _processItems(t, e) {
                    for (let s = 0, n = t.length; s < n; s++)
                        ...
                        } else if ("beginMarkedContentProps" === t[s].type || "beginMarkedContent" === t[s].type) {
                        const e = this._container;
                        this._container = document.createElement("span");
                        this._container.classList.add("markedContent");
                        null !== t[s].id && this._container.setAttribute("id", `${t[s].id}`);
                        e.append(this._container)
                    } else "endMarkedContent" === t[s].type && (this._container = this._container.parentNode)
                }
                _layoutText(t) {
                    ...
                    if (0 !== e.canvasWidth && e.hasText) {
                        ...
                        const {
                            width: r
                        } = this._layoutTextCtx.measureText(t.textContent);
                        if (r > 0) {
            ...
            e.SVGGraphics = a;
            {
                    ...
                    createObjectURL = function(t, e = "", s = !1) {
                        ...
                        for (let e = 0, s = t.length; e < s; e += 3) {
                            const r = 255 & t[e],
                                a = 255 & t[e + 1],
                                o = 255 & t[e + 2];
                            i += n[r >> 2] + n[(3 & r) << 4 | a >> 4] + n[e + 1 < s ? (15 & a) << 2 | o >> 6 : 64] + n[e + 2 < s ? 63 & o : 64]
                        }
                        return i
                    },
                    u = function() {
                            ...
                            const m = new Uint8Array([o >> 24 & 255, o >> 16 & 255, o >> 8 & 255, 255 & o, l >> 24 & 255, l >> 16 & 255, l >> 8 & 255, 255 & l, c, h, 0, 0, 0]),
                                b = function deflateSync(t) {
                                    ...
                                    try {
                                        ...
                                        const s = require("zlib").deflateSync(e, {
                                            level: 9
                                        });
                ...
                e.SVGGraphics = a = class {
                    ...
                    endText() {
                        const t = this.current;
                        if (t.textRenderingMode & i.TextRenderingMode.ADD_TO_PATH_FLAG && t.txtElement?.hasChildNodes()) {
                    ...
                    _makeTilingPattern(t) {
                        const e = t[1],
                            ...
                            d = t[7],
                            u = "shading" + f++,
                            [p, g, m, b] = i.Util.normalizeRect([...i.Util.applyTransform([r, a], n), ...i.Util.applyTransform([o, l], n)]),
                    ...
                    constructPath(t, e) {
                        ...
                        for (const s of t) switch (0 | s) {
                            case i.OPS.rectangle:
                                ...
                                const t = n + e[o++],
                                    s = r + e[o++];
                                a.push("M", pf(n), pf(r), "L", pf(t), pf(r), "L", pf(t), pf(s), "L", pf(n), pf(s), "Z");
                                break;
                            case i.OPS.moveTo:
                                n = e[o++];
                                r = e[o++];
                            ...
                            case i.OPS.curveTo:
                                n = e[o + 4];
                                r = e[o + 5];
                                a.push("C", pf(e[o]), pf(e[o + 1]), pf(e[o + 2]), pf(e[o + 3]), pf(n), pf(r));
                                o += 6;
                                break;
                            case i.OPS.curveTo2:
                                a.push("C", pf(n), pf(r), pf(e[o]), pf(e[o + 1]), pf(e[o + 2]), pf(e[o + 3]));
                                n = e[o + 2];
                                r = e[o + 3];
                                o += 4;
                                break;
                        ...
                        a = a.join(" ");
                        if (s.path && t.length > 0 && t[0] !== i.OPS.rectangle && t[0] !== i.OPS.moveTo) a = s.path.getAttributeNS(null, "d") + a;
                        else {
                    ...
                    paintImageXObject(t) {
                        ...
                        e ? this.paintInlineImageXObject(e) : (0, i.warn)(`Dependent image with object ID ${t} is not ready yet`)
                    }
            ...
            e.PDFNodeStream = class PDFNodeStream {
                ...
                getRangeReader(t, e) {
                    if (e <= this._progressiveDataLength) return null;
                    const s = this.isFsUrl ? new PDFNodeStreamFsRangeReader(this, t, e) : new PDFNodeStreamRangeReader(this, t, e);
            ...
            class PDFNodeStreamFullReader extends BaseFullReader {
                constructor(t) {
                        ...
                        const getResponseHeader = t => this._readableStream.headers[t.toLowerCase()],
                            {
                                ...
                                suggestedLength: r
                            } = (0, i.validateRangeRequestCapabilities)({
                    ...
                    this._request = null;
                    "http:" === this._url.protocol ? this._request = a.request(createRequestOptions(this._url, t.httpHeaders), handleResponse) : this._request = o.request(createRequestOptions(this._url, t.httpHeaders), handleResponse);
            ...
            class PDFNodeStreamFsRangeReader extends BaseRangeReader {
                constructor(t, e, s) {
                    ...
                    this._setReadableStream(r.createReadStream(n, {
                        start: e,
                        end: s - 1
                    }))
                }
            ...
            e.createResponseStatusError = function createResponseStatusError(t, e) {
                ...
                return new n.UnexpectedResponseException(`Unexpected server response (${t}) while retrieving PDF "${e}".`, t)
            };
            ...
            class PDFFetchStreamReader {
                constructor(t) {
                    ...
                    const s = e.url;
                    fetch(s, createFetchOptions(this._headers, this._withCredentials, this._abortController)).then((t => {
            ...
            class PDFFetchStreamRangeReader {
                constructor(t, e, s) {
                    ...
                    fetch(a, createFetchOptions(this._headers, this._withCredentials, this._abortController)).then((t => {
                        if (!(0, i.validateResponseStatus)(t.status)) throw (0, i.createResponseStatusError)(t.status, a);
                        this._readCapability.resolve();
                        this._reader = t.body.getReader()
